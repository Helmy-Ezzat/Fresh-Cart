  ...
  return <>
    ...
    <div className=' w-50 m-auto mt-5'>
      ...
      <div className='text-center'>
        <button onClick={comfirmCashPayment} className='btn btn-success w-25'> Cash Payment</button>
        <button onClick={comfirmOnlinePayment} className='btn btn-success ms-2 w-25'> Online Payment</button>
      </div>
    </div>
