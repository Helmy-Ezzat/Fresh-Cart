...
export default function Cart() {
  ...
  const { isError, isLoading, data } = useQuery('getUserCart', getUserCart)
      ...
      {numOfCartItems !== 0 ? (
        <div className="container Cart mt-3">
          ...
          {allProducts.map((product, idx) => (
            <div
              key={idx}
              className="row shadow-lg sell rounded-2 p-5 mt-2 py-3 d-flex justify-content-center mb-1"
            >
              <div className="col-1">
                <figure>
                  <img
              ...
              <div className="col-9">
                <article>
                  ...
                  >
                    <i className="fa-solid fa-trash border-light"></i> Remove
                  </button>
                </article>
              </div>
              <div className="col-2">
